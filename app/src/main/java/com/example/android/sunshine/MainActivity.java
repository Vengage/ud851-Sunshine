...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int FORECAST_LOADER_ID = 101;
    private static final String FORECAST_LOCATION = "location";
    ...
    private void loadWeatherData() {
        ...
        args.putString(FORECAST_LOCATION, location);

        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String[]> loader = loaderManager.getLoader(FORECAST_LOADER_ID);
        if(loader == null){
            loaderManager.initLoader(FORECAST_LOADER_ID, args, this);
        }
        else {
            loaderManager.restartLoader(FORECAST_LOADER_ID, args, this);
        }
    }
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            protected void onStartLoading() {
                ...
                if(mLocationString != null) {
                    deliverResult(mLocationString);
                } else forceLoad();
            }

            @Override
            public void deliverResult(String[] data) {
                mLocationString = data;
            ...
            /* If there's no zip code, there's nothing to look up. */
                ...
                String location = args.getString(FORECAST_LOCATION);
