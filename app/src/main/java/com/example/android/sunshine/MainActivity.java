...
//        mWeatherTextView = (TextView) findViewById(R.id.tv_weather_data);
        ...
        mForecastAdapter = new ForecastAdapter(this, null);
    ...
    @Override
    public void onListItemClick(String itemClicked) {
        if(mToast!=null){
            mToast.cancel();
        }

        mToast = Toast.makeText(this, itemClicked,Toast.LENGTH_SHORT);
        mToast.show();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            mForecastAdapter = new ForecastAdapter(MainActivity.this, null);
            mRecyclerView.setAdapter(mForecastAdapter);
            loadWeatherData();
            return true;
        }
